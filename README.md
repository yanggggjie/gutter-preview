# Image Preview V2 - Visual Studio Code Extension

> 🍴 **Forked from [kisstkondoros/gutter-preview](https://github.com/kisstkondoros/gutter-preview) v0.32.2**  
> Enhanced with AI-powered bug fixes and improvements starting from v0.40.0

Shows image preview in the gutter and on hover, with enhanced support for data URIs and complex SVG images.

## What's New in V2

- ✅ **Fixed data URI recognition** without quotes (e.g., `url(data:image/...)`)
- ✅ **Fixed double encoding issue** for already encoded data URIs
- ✅ **Fixed hover preview** not displaying for complex SVG data URIs
- ✅ **Better rendering** using HTML img tags for data URI compatibility
- ✅ **Intelligent encoding detection** to prevent data corruption
...
Search for "Image preview V2" in VS Code Extensions, or:

[How to install Visual Studio Code extensions](https://code.visualstudio.com/docs/editor/extension-gallery)

**Original Extension:** [kisstkondoros.vscode-gutter-preview](https://marketplace.visualstudio.com/items?itemName=kisstkondoros.vscode-gutter-preview)  
**This Fork:** [yanggggjie.vscode-gutter-preview-v2](https://marketplace.visualstudio.com/items?itemName=yanggggjie.vscode-gutter-preview-v2)

### Change Log

#### V2 Fork by yanggggjie (Starting from 0.40.0)

- **0.40.0** (AI-Enhanced Release)
    - 🍴 Forked from [kisstkondoros/gutter-preview](https://github.com/kisstkondoros/gutter-preview) v0.32.2
    - 🤖 AI-powered bug analysis and fixes
    - 🐛 **Fix:** Data URI recognition without quotes (e.g., `url(data:image/...)`)
    - 🐛 **Fix:** Double encoding issue for already encoded data URIs
    - 🐛 **Fix:** Hover preview not displaying for complex SVG data URIs
    - ✨ **Enhancement:** Use HTML img tags for better data URI rendering
    - ✨ **Enhancement:** Intelligent encoding detection to prevent data corruption
    - 📝 **Tech:** Improved recognizer patterns and escape handling
    - 📝 **Tech:** Enhanced Markdown rendering with HTML support

---

#### Original Version History (by Tamas Kiss)
...
**Original Author:** [Tamas Kiss](https://github.com/kisstkondoros) (kisstkondoros)  
**Original Repository:** [kisstkondoros/gutter-preview](https://github.com/kisstkondoros/gutter-preview)

**Fork Maintainer:** [yanggggjie](https://github.com/yanggggjie)  
**Fork Repository:** [yanggggjie/gutter-preview](https://github.com/yanggggjie/gutter-preview)

### License

Licensed under MIT

This project is a fork of the original [gutter-preview](https://github.com/kisstkondoros/gutter-preview) extension, maintaining the same MIT license. All credit for the original implementation goes to Tamas Kiss.
